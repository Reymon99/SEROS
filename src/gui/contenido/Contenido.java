...
public class Contenido extends Lienzo {
    ...
    private void init() {
        ...
        Constrains.addComp(back=new Boton(Text.VENTANAPRINCIPAL.toString(), Archivos.image("/recourses/image/back.png",-1,-1),new MouseAdapter() {
            @Override
        ...
        Constrains.addComp(next=new Boton(Archivos.image("/recourses/image/next.png",-1,-1)),this,new Rectangle(2,2,1,1), 0,0,new Insets(10,2,10,7), GridBagConstraints.SOUTHEAST,GridBagConstraints.NONE);
    }
    /**
