...
public abstract class Constrains {
     ...
     * @param stretch llenado dentro del espacio del grid
     */
    public static void addCompI(Component component,Container container,Rectangle rectangle,double weightx,double weighty,Insets insets,int ipadx,int ipady,int place,int stretch){
        GridBagConstraints grid=grid(rectangle, insets, place, stretch);
        grid.weightx=weightx;
        grid.weighty=weighty;
        grid.ipadx=ipadx;
